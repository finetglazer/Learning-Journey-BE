...
public interface TimelineService {
    ...
    BaseResponse<?> getTimelineStructure(Long userId, Long projectId, GetTimelineStructureRequest request);
    BaseResponse<?> deleteTimeline(Long userId, Long projectId, DeleteTimelineRequest request);
