package com.graduation.forumservice.config;
...
public class KafkaConfig {
    ...
    // 1. Updated Topic Name for Forum Activity
    ...
    // 2. Updated Bean to create the Forum Topic
    @Bean
    public NewTopic forumActivityTopic() {
        return TopicBuilder.name(TOPIC_FORUM_ACTIVITY)
                .partitions(1)
                .replicas(1)
                .build();
    }
