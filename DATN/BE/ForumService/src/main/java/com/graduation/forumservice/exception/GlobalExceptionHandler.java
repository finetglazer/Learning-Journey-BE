package com.graduation.forumservice.exception;
...
public class GlobalExceptionHandler {
    ...
    public BaseResponse<?> handleGeneral(Exception ex) {
        ...
        // We do NOT send ex.getMessage() here because it might contain sensitive SQL
        // info.
    ...
    public BaseResponse<?> handleIllegalArgument(IllegalArgumentException ex) {
        ...
        // Return the actual message (e.g., "Unsupported file type:
